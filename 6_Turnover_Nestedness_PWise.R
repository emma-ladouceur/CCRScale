...
np_wide <-ccr_dat %>% filter(site_status == "never-plowed") %>% 
  ...
  group_by(site_status,Year,YSA,Field,species2) %>% 
...
write.csv(beta.df,"~/GRP GAZP Dropbox/Emma Ladouceur/_Projects/CCRScale/data/beta.df.pwise.csv")

beta<-read.csv("~/GRP GAZP Dropbox/Emma Ladouceur/_Projects/CCRScale/data/beta.df.pwise.csv", header=TRUE) %>%
  as_tibble()
...
ccr.turnover.pwise <- brm(jtu ~  YSA + (1 + YSA | Field) + (1 | Year),
...
summary(ccr.turnover.pwise)

waic(ccr.turnover)
waic(ccr.turnover.pwise)



pp_check(ccr.turnover.pwise) + theme_classic()
...
save(ccr.turnover.pwise, file = '~/GRP GAZP Dropbox/Emma Ladouceur/_Projects/CCRScale/data/model_fits/betat.pwise.Rdata')

ccr.nest.pwise <- brm(jne ~  YSA + (1 + YSA | Field) + (1 | Year),
...
summary(ccr.nest)
summary(ccr.nest.pwise)
color_scheme_set("darkgray")
pp_check(ccr.nest.pwise) + theme_classic()

plot(ccr.nest.pwise)

save(ccr.nest.pwise, file = '~/GRP GAZP Dropbox/Emma Ladouceur/_Projects/CCRScale/data/model_fits/betan.pwise.Rdata')


load("~/GRP GAZP Dropbox/Emma Ladouceur/_Projects/CCRScale/data/model_fits/betat.pwise.Rdata") # object name: ccr.turnover
load("~/GRP GAZP Dropbox/Emma Ladouceur/_Projects/CCRScale/data/model_fits/betan.pwise.Rdata") # object name: ccr.nest


betat_fitted <- cbind(ccr.turnover.pwise$data,
                      fitted(ccr.turnover.pwise, re_formula = NA)) %>% 
  as_tibble() 


betat_fixef <- fixef(ccr.turnover.pwise)

betat_coef <- coef(ccr.turnover.pwise)
...
View(betat_coef2)
 ...
 save(betat_fitted,betat_fixef,betat_coef,betat_coef2, file = 'betat.mod_dat_pwise.Rdata')
load('~/GRP GAZP Dropbox/Emma Ladouceur/_Projects/CCRScale/data/betat.mod_dat_pwise.Rdata')


betan_fitted <- cbind(ccr.nest.pwise$data,
                      fitted(ccr.nest.pwise, re_formula = NA)) %>% 
  as_tibble() 

betan_fixef <- fixef(ccr.nest.pwise)

betan_coef <- coef(ccr.nest.pwise)
...
setwd('~/GRP GAZP Dropbox/Emma Ladouceur/_Projects/CCRScale/data/')
save(betan_fitted,betan_fixef,betan_coef,betan_coef2, file = 'betan.mod_dat_pwise.Rdata')
load('~/GRP GAZP Dropbox/Emma Ladouceur/_Projects/CCRScale/data/betan.mod_dat_pwise.Rdata')
